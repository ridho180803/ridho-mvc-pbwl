...
<head>
	...
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/PLN.png" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			...
			<div class="user">PT. PLN KARYA</div>
		</header>
			...
			<ul>
				<li>
					<a href="<?php echo URL; ?>/dashboard">
						<img class="icon" src="<?php echo AST; ?>/img/Menupln.png" alt=""> Dashboard
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023. Designed by RIDHO
	</main>
